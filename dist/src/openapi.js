...
export const OPENAPI = {
    ...
    info: {
        ...
        version: "1.0.0",
        description: "Transliteration and neural text processing. Maps run in-edge on the interscript-ts native interpreter (289 systems); neural models (diacritization, grapheme-to-phoneme) run on Interscript's inference service. GraphQL remains available at POST /graphql.",
    ...
    paths: {
        ...
        "/v1/infer": {
            post: {
                ...
                description: "Proxy to Interscript's inference service. Only models whose task is diacritization or g2p are served; see GET /v1/models for the catalog.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
