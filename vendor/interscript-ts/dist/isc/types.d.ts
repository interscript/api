...
export type IscStageItem = {
    ...
    kind: "funcall";
    name: string;
    kwargs: Readonly<Record<string, string>>;
};
...
export type IscItem = {
    ...
    type: "concat";
    parts: readonly IscItem[];
} | {
    type: "set";
    items: readonly IscItem[];
} | {
    type: "range";
    lo: string;
    hi: string;
...
export declare class IscParseError extends Error {
    readonly position: number;
    readonly line: number;
    readonly col: number;
    constructor(message: string, position: number, line: number, col: number);
}
