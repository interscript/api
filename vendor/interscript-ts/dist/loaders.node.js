 ...
 */
export function filesystemStrategy(mapsDir) {
    return (systemCode) => {
        const path = resolve(mapsDir, `${systemCode}.json`);
        try {
            const raw = readFileSync(path, "utf8");
            return normaliseMap(JSON.parse(raw));
        }
        catch {
            return undefined;
        }
 ...
 */
export function relativeFilesystemStrategy(relativeTo, relativePath) {
...
//# sourceMappingURL=loaders.node.js.map