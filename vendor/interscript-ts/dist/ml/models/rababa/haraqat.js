 ...
 */
export const BASIC_HARAQAT = Object.freeze({
    "َ": "Fatha",
    "ً": "Fathatah",
    "ُ": "Damma",
    "ٌ": "Dammatan",
 ...
 */
export const ALL_POSSIBLE_HARAQAT = Object.freeze({
    "": "No Diacritic",
    "َ": "Fatha",
    "ً": "Fathatah",
    "ُ": "Damma",
 ...
 * `@target_symbol_to_id`.
 */
export const HARAAQAT_TO_ID = Object.freeze(Object.fromEntries(Object.keys(ALL_POSSIBLE_HARAQAT).map((k, i) => [k, i])));
/**
...
export const INPUT_VOCAB = [PAD_SYMBOL, ...INPUT_CHARS];
export const INPUT_SYMBOL_TO_ID = Object.freeze(Object.fromEntries(INPUT_VOCAB.map((s, i) => [s, i])));
export const INPUT_ID_TO_SYMBOL = INPUT_VOCAB;
//# sourceMappingURL=haraqat.js.map